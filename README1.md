# The application described below in manual run is run here with the help of a Docker file that defines:
# a base software to run > 
# working folder >
# copying and downloading prerequisites > 
